...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numero1 = findViewById(R.id.numero2);
    ...
    public void btnSubtracao(View v){
        int intNumero1 = Integer.parseInt(numero1.getText();
        int intNumero2 = Integer.parseInt(numero2.getText();
    ...
    public void btnDivisao(View v){
        int intNumero1 = Integer.parseInt(numero1.getText().toString());
        intNumero2 = Integer.parseInt(numero2.getText().toString());
